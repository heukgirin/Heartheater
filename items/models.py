...
class ItemsFrame(models.Model):
    item = models.ForeignKey(ItemsBasic, on_delete=models.CASCADE)
    incount = models.IntegerField(default=1)
    inconts = models.TextField()
